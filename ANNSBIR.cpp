// ANNSBIR.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CANNSBIRApp, CWinApp)
	//{{AFX_MSG_MAP(CANNSBIRApp)
...
/////////////////////////////////////////////////////////////////////////////
// CANNSBIRApp construction

CANNSBIRApp::CANNSBIRApp()
{
...
/////////////////////////////////////////////////////////////////////////////
// The one and only CANNSBIRApp object

CANNSBIRApp theApp;

/////////////////////////////////////////////////////////////////////////////
// CANNSBIRApp initialization

BOOL CANNSBIRApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CANNSBIRDoc),
		RUNTIME_CLASS(CMainFrame),       // main SDI frame window
		RUNTIME_CLASS(CANNSBIRView));
...
/////////////////////////////////////////////////////////////////////////////
// CANNSBIRApp message handlers

void CANNSBIRApp::OnFileOpen() 
{
